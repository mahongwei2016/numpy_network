...
class ThreeLayerNet:
    def __init__(self,input_size,hidden1_size,hidden2_size,output_size,weight_init_std=0.01):
        ...
        self.params['b1']=weight_init_std*np.zeros(hidden1_size)
        self.params['W2']=weight_init_std*np.random.randn(hidden1_size,hidden2_size)
        self.params['b2']=weight_init_std*np.zeros(hidden2_size)
        self.params['W3']=weight_init_std*np.random.randn(hidden2_size,output_size)
        self.params['b3']=weight_init_std*np.zeros(output_size)
        #layer
...
'''
(x_train,t_train),(x_test,t_test)=load_mnist()
network=ThreeLayerNet(input_size=784,hidden1_size=20,hidden2_size=20,output_size=10) 
iters_num=100000
